...
export const metadata = {
  title: "Nintendo",
  description:
    "Nintendo's Landing page cloned to showcase excellent design skill!",
};
        ...
        <header>
          ...
          <nav>
            <ul>
              <li>
                <span>
                  <img src="/support.svg" alt="support" className="nav-svg" />
                </span>
                <a href="#">Support</a>
              </li>
              <li>
                <span>
                  <img src="/wishlist.svg" alt="wishlist" className="nav-svg" />
                </span>
                <a href="#">Wishlist</a>
              </li>
              <li>
                <span>
                  <img src="/cart.svg" alt="cart" className="nav-svg" />
                </span>
                <a href="#">Cart</a>
              </li>
            </ul>
